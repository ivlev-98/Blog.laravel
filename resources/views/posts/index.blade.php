                ...
                <article class="post">
                    ...
                    <div class="post__controls">
                        <div><span> 
                            ...
                            </svg>123</span><span class="action selected">
                            ...
                            </svg>8</span><a href="/post.html#comments">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" width="1em" height="1em">
...
@endsection
@section('nav')
    <a {{ Route::currentRouteName() === "index" ? "class=selected" : "" }} href="{{ route('index') }}">Все</a>
    <a href="/auto">Автомобили</a>
    <a href="/trevel">Путешествия</a>
